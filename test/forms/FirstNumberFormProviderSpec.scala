...
class FirstNumberFormProviderSpec extends IntFieldBehaviours {

  val form = new FirstNumberFormProvider()()
  ...
  ".value" - {
    ...
    behave like mandatoryField(
      form,
      fieldName,
      requiredError = FormError(fieldName, "firstNumber.error.required")
    )
  }
}
